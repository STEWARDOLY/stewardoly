...
// ═══════════════════════════════════════════════════════════════
const APOSTLES = [
  { id:'paul', emj:'✉️', name:'Paul of Tarsus', intro:'Paul appears with a mission!', body:'"Support the church-planting mission. Give 100T?"', verse:'2 Cor 9:7', task:'donate100', acceptFx:-100, acceptVp:3, acceptWisdom:2, declineVp:-1, quote:'"He who supplies seed multiplies your seed." — 2 Cor 9:10' },
  { id:'peter', emj:'🗝️', name:'Simon Peter', intro:'Peter calls you to step out in faith!', body:'"Cast your nets! Risk 80T — flip a coin: win 200T or lose your stake."', verse:'John 21:6', task:'gamble', acceptFx:-80, gamble:true, gambleWin:200, acceptVp:1, quote:'"Lord, command me to come to you on the water." — Matt 14:28' },
  { id:'john', emj:'❤️', name:'John the Beloved', intro:'John meets you on the road!', body:'"Love your neighbor — give 60T to the poorest."', verse:'1 John 4:7', task:'giveToPoorest', acceptFx:-60, acceptVp:3, acceptWisdom:1, declineVp:-1, quote:'"Beloved, let us love one another." — 1 John 4:7' },
  { id:'james', emj:'⚖️', name:'James the Just', intro:'James the Just challenges you.', body:'"Faith without works is dead! Build a ministry now (if able) for +50T blessing."', verse:'James 2:17', task:'buildMinistry', acceptVp:2, acceptWisdom:1, acceptBonusFx:50, quote:'"Pure religion is to care for orphans and widows." — James 1:27' },
  { id:'mary', emj:'🌹', name:'Mary of Bethany', intro:'Mary anoints you with costly perfume!', body:'"Tithe 10% of your Talents — pour out all you have in worship."', verse:'John 12:3', task:'tithe10pct', acceptVp:3, acceptWisdom:2, quote:'"She has done a beautiful thing to me." — Mark 14:6' },
  { id:'andrew', emj:'🐟', name:'Andrew', intro:'Andrew brings a friend to meet you!', body:'"Share 25T with each fellow pilgrim — generosity multiplied!"', verse:'John 1:42', task:'shareToAll', shareToAll:25, acceptVp:2, acceptWisdom:1, quote:'"We have found the Messiah!" — John 1:41' },
  { id:'barnabas', emj:'💛', name:'Barnabas', intro:'Barnabas the Encourager comes alongside.', body:'"Sell some land — give 50T, gain 100T net for the cause."', verse:'Acts 4:36', task:'sellForKingdom', acceptFx:-50, acceptBonusFx:100, acceptVp:2, acceptWisdom:1, quote:'"He sold a field he owned..." — Acts 4:37' },
  { id:'thomas', emj:'🔍', name:'Thomas', intro:'Thomas appears with a question of faith.', body:'"Trust without seeing? Risk 50T — flip a coin: 150T or lose."', verse:'John 20:29', task:'gambleSmall', acceptFx:-50, gamble:true, gambleWin:150, acceptVp:1, declineVp:-1, quote:'"Blessed are those who have not seen yet believed." — John 20:29' },
];
